...
C = require "user.default_theme.colors"

for _, module in ipairs(modules) do
  highlights = vim.tbl_deep_extend("force", highlights, require("user.default_theme." .. module))
end

for group, spec in pairs(user_plugin_opts("user.default_theme.highlights", highlights)) do
